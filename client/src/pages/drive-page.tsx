  ...
  return (
    <>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 animate-in fade-in slide-in-from-top-4 duration-500">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Dialog open={isNewFolderOpen} onOpenChange={setIsNewFolderOpen}>
            ...
            <DialogContent className="w-full sm:max-w-lg mx-4">
              <DialogHeader>
      ...
      <Dialog open={isMoveOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="w-full sm:max-w-lg max-h-[80vh] mx-4">
          <DialogHeader>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y">
                    {paginatedReports?.map(r => (
                        ...
                        <td className="py-2 md:py-4 pl-4 pr-2 md:pr-0 text-right align-middle">
